...
class boxnow extends CarrierModule
{
    ...
    public function install()
    {
        ...
        if (!Configuration::hasKey('BOXNOW_MAP_MODE')) {
            Configuration::updateValue('BOXNOW_MAP_MODE', 'iframe');
        }
 ...
 protected function getConfigForm()
{
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'BOXNOW_MAP_MODE' => Configuration::get('BOXNOW_MAP_MODE', 'iframe'), //popup | iframe
    ...
    public function hookDisplayCarrierExtraContent(array $params)
    {
        ...
        PrestaShopLogger::addLog('Cart delivery address ID: ' . $id_address, 1);
        ...
        if (Validate::isLoadedObject($address)) {
            ...
            if (Validate::isLoadedObject($country)) {
                ...
                PrestaShopLogger::addLog('Boxnow selected country: ' . $selected_country, 1);
            }
        }
        ...
        if (!empty($result['id_order'])) {
            ...
            $this->context->smarty->assign(
                array(
                    ...
                    'total_order_products' => $totalQuantity,
                    'boxnow_createvoucher_link' => $this->context->link->getModuleLink('boxnow', 'createvoucher'),
                    'boxnow_cancelvoucher_link' => $this->context->link->getModuleLink('boxnow', 'cancelvoucher'),
                )
            );
    ...
    public static function formatPhone($numOld)
    {
        ...
        if (substr($numOld, 0, 1) != '+') {
            ...
            elseif (in_array(substr($numOld, 0, 2), ['22', '23', '24', '25', '26', '96', '97', '98', '99']) && strlen(preg_replace('/[^\d]/', '', $numOld)) < 9) {
                $numOld = '+357' . preg_replace('/[^\d]/', '', $numOld);
            }
            // If none of the above conditions match, put "+30" in the beginning
            else {
                $numOld = '+30' . preg_replace('/[^\d]/', '', $numOld);
            }
        }
        return $numOld;
    }
